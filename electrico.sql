...
--
-- Servidor: localhost
-- Tiempo de generación: 01-02-2019 a las 17:26:32
...
(3, 'Polonia', 'Castro', 'Valpo', 'polo@algo.com', 911111111, '40bd001563085fc');
...
--
ALTER TABLE `usuario`
  MODIFY `id_usu` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
